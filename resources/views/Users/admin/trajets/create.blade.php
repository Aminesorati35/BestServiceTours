    ...
    <div class="trajet-card">
        <div class="trajet-header">
            <div class="header-content">
                <h2 class="trajet-title">Add Trip <span class="animated-icon">✈</span></h2>
                <p class="trajet-subtitle">Add a new Trip to your fleet in just a few clicks</p>
            </div>
        </div>
        ...
        <div class="trajet-form-container">
            <div class="form-progress">
                <div class="progress-step">
                    ...
                    <div class="step-text">Trip Registration</div>
                </div>
            </div>

            <form action="{{ route('admin.trajets.store') }}" method="POST" enctype="multipart/form-data" id="modifierForm">
                @csrf
                @method('POST')
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="depart" name="depart" value="{{ old('depart') }}" placeholder="Ex: Casablanca">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="arrivee" name="arrivee" value="{{ old('arrivee',) }}" placeholder="Ex: Marrakech">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="duree_estimee" name="duree_estimee" min="0" value="{{ old('duree_estimee') }}" placeholder="Ex: 120">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="prix" name="prix" step="0.01" min="0" value="{{ old('prix') }}" placeholder="Ex: 150.00">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" class="form-control" id="description" name="description" value="{{ old('description') }}" placeholder="Décrivez votre trajet en quelques mots">
